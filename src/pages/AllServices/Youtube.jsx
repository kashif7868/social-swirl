...
import dmbImage from "../../asset/images/banner/yt-b.jpg";
import dmpImage from "../../asset/images/banner/yt-p.jpg";
import dmp1Image from "../../asset/images/banner/yt-p1.jpg";
      ...
      <section className="dm-headings">
        <div className="dm-image-container relative">
          ...
          <div className="text-overlay absolute inset-0 flex flex-col justify-center items-center text-center">
            ...
            <p className="text-lg text-white">Services / Youtube</p>
            <Link to="/service">
      ...
      <section className="dm-details2 mt-8">
        <div className="flex flex-col md:flex-row">
          <div className="det md:w-1/2 md:pr-8">
            <h1 className="text-2xl font-bold">Content Creater</h1>
            <p className="text-justify">
