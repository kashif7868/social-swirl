...
import dmbImage from "../../asset/images/banner/go-b.jpg";
import dmpImage from "../../asset/images/banner/go-p.jpg";
import dmp1Image from "../../asset/images/banner/go-p1.jpg";
      ...
      <section className="dm-headings">
        <div className="dm-image-container relative">
          ...
          <div className="text-overlay absolute inset-0 flex flex-col justify-center items-center text-center">
            <h2 className="text-4xl font-bold text-white">Google Ads</h2>
            <p className="text-lg text-white">Services /Google Ads</p>
            <Link to="/service">
              <button className="normal4 px-6 py-2 text-white font-semibold rounded">
                Our Services
              </button>
            </Link>
          </div>
      ...
      <section className="dm-details2 mt-8">
        <div className="flex flex-col md:flex-row">
          <div className="det md:w-1/2 md:pr-8">
            <h1 className="text-2xl font-bold">Bid Strategies</h1>
            <p className="text-justify">
