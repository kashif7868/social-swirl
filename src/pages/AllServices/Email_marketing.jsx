...
import dmbImage from "../../asset/images/banner/em-b.jpg";
import dmpImage from "../../asset/images/banner/em-p.jpg";
import dmp1Image from "../../asset/images/banner/em-p1.jpg";
      ...
      <section className="dm-headings">
        <div className="dm-image-container relative">
          ...
          <div className="text-overlay absolute inset-0 flex flex-col justify-center items-center text-center">
            <h2 className="text-4xl font-bold text-white">Email Marketing</h2>
            <p className="text-lg text-white">Services / Email Marketing</p>
            <Link to="/service">
      ...
      <section className="dm-details mt-8">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="det md:w-1/2 md:pl-8">
            <h1 className="text-2xl font-bold">Permission-Based</h1>
      ...
      <section className="dm-details2 mt-8">
        <div className="flex flex-col md:flex-row">
          <div className="det md:w-1/2 md:pr-8">
            <h1 className="text-2xl font-bold">More About Email Marketing</h1>
            <p className="text-justify">
